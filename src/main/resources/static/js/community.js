...
$(document).ready(function(){
    ...
    a.getTop('http://api.nanfeng.hejianpeng.cn/public/post/get-by-page',{page,isTop:1,plate:nowtype});
    $('.ass').on('click',() =>{
...
a.addLIS('http://api.nanfeng.hejianpeng.cn/public/post/get-by-page',{page,isTop:0,plate:nowtype});
...
replyPage++;
    a.addCONTS('http://api.nanfeng.hejianpeng.cn/public/postReply/get-by-page',{page:replyPage,postId:mypostId});
                    ...
                    if(document.getElementsByClassName('abc').length !== 0){
                        ...
                        for(let i =0;i<lg;i++){
                            let a = new Promise(function(re,rj){
                                ...
                                Vue.http.post(allurl+'http://api.nanfeng.hejianpeng.cn/public/pic/token',{fileName:Math.random()}, {emulateJSON: true,credentials:true}).then(  (response) => {
...
self.location.href="/sign_in" ;
        ...
        this.another(saveP.A,saveP.B,saveP.C);
              /*this.conts = [];
              a.addCONTS('http://api.nanfeng.hejianpeng.cn/private/postReply/add',p.postId); */
    ...
    getTop(url,p={}){
          ...
          if(nowtype ==0){
            url = 'http://api.nanfeng.hejianpeng.cn/public/post/get-all-by-page';
            delete p.plate;
            delete p.isTop;
        }
