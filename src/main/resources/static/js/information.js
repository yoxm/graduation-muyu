...
$(document).ready(function(){
    ...
    a.getTop('http://api.nanfeng.hejianpeng.cn/public/news/get-by-page',{page,type:nowtype,isTop:1});
    $('.ass').on('click',() =>{
         a.getTop('http://api.nanfeng.hejianpeng.cn/public/news/get-by-page',{page,type:nowtype,isTop:1});
         ifnull = false;
window.scrollTo(0,0);
...
page++;
a.addLIS('http://api.nanfeng.hejianpeng.cn/public/news/get-by-page',{page,type:nowtype,isTop:0});
   ...
   replyPage++;
    a.addCONTS('http://api.nanfeng.hejianpeng.cn/public/newsReply/get-by-page',{page:replyPage,newsId:mypnewsId,isTop:0});
